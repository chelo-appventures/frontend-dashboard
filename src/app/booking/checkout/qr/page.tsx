            ...
            <div className="flex min-h-screen flex-col items-center bg-gray-300 max-h-screen">
                <div className=" bg-[#F4F4F7] w-full min-h-full flex flex-col" >
                    ...
                    {/* TODO DEBE IR DENTRO DE ESTE CONTAINER */}
                        ...
                        <h1 className="w-[814px] text-left text-[36px] text-[#10004f]"><strong>Comprobante / eTicket</strong></h1>
                        <div className="w-[813px] h-auto bg-white my-6 rounded-lg shadow-lg">
                            <div className="flex flex-row-w-full bg-[#3198A5] rounded-t-lg py-6 px-10">
                                <p className="font-semibold text-white text-[24px] text-justify">Recuerda cancelar el saldo del servicio antes de comenzar el viaje. Podrás hacerlo ingresando mediante el código QR.</p>
                            </div>
                            <div className="flex flex-row">
                                <div className="flex flex-col w-1/3 m-[60px]">
                                    <div className="flex items-center bg-[#3198A5] h-[26px] w-[232px] mb-5">
                                        ...
                                        <p className="text-white font-semibold text-[14px]">EN MINIBUS</p>
                                    </div>
                                    <AVQRCode text="A viajarrr!!!" />
                                    <div className="my-5">
                                        <p className={`${ruda.className} font-bold text-[#5C5C5C] text-[16px]`}>Código:</p>
                                ...
                                <div className="flex flex-col mt-[60px]">
                                    <div className="mb-6">
                                        <p className={`${ruda.className} font-bold text-[#5C5C5C] text-[16px]`}>Origen / Destino:</p>
                                        <p className="text-[48px] font-semibold text-[#10004f]">Belgrano / Pinamar</p>
                                    </div>
                                    <div className="mb-6">
                                        <p className={`${ruda.className} font-bold text-[#5C5C5C] text-[16px]`}>Salida:</p>
                                        <p className="text-[32px] font-semibold text-[#10004f]">15 de Feb 2024 / 23:00</p>
                                    </div>
                                    <div className="mb-6">
                                        <p className={`${ruda.className} font-bold text-[#5C5C5C] text-[16px]`}>Desde:</p>
                                        <p className="text-[32px] font-semibold text-[#10004f]">Av. Cmd. Rivadavia 1450</p>
                                    </div>
                                    <div className="mb-6">
                                        <p className={`${ruda.className} font-bold text-[#5C5C5C] text-[16px]`}>Pasajero:</p>
                                        <p className="text-[32px] font-semibold text-[#10004f]">Gonzalo García Luna</p>
                                        <p className="text-[20px] font-semibold text-[#8B8B8B]">1 mascota en falda</p>
                                    </div>
                                </div>
                            </div>
